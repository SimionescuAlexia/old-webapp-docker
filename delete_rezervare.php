...
if (isset($_GET['id'])) {
  ...
  header('Location: delete_rezervare.php');
  exit();
}
      ...
      <tbody>
        <?php while ($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <td><a class="delete-button" href="delete_rezervare.php?id=<?= $row['id'] ?>" onclick="return confirm('Sigur vrei să ștergi această rezervare?');">Șterge</a></td>
          </tr>
        <?php endwhile; ?>
      </tbody>
    </table>
